<template>
  ...
  <el-row>
    ...
    <el-col v-if="logined" class="hidden-xs-only" :span="6" :offset="12">
      <img style="vertical-align: middle;" :src="userInfos&&userInfos.avatar_url" height="30" alt=""> <a href="#" style="color:#fff;">{{userInfos&&userInfos.loginname}}</a>
...
<script>
  ...
  export default {
    ...
    methods:{
      login(){
        this.$router.push({
          path:'/login'   //往url里地址后边添加一个 让他去路由规则里找对应的
        })
      },
      logout(){
